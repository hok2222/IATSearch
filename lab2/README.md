...
1.  Развить практические наыки использования языка программирования R для обработки данных
...
Пакет dplyr можно установит в RStudio Desktop с помощью команды install.packages("dplyr") Далее подключим пакет к текущему проекте с помощью library(dplyr)
