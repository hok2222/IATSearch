...
В данной работе я смог исследовать файл с выгрузкой данных из системы SIEM и помог выявить факт компрометации. Также изучил структуру журнала системы Windows Active Directorу
