...
Используя программный пакет dplyr языкампрограммирования R провести
...
```
    ...
    Warning: There were 12129 warnings in `summarise()`.
    The first warning was:
    ℹ In argument: `Mean_Power = mean(Power)`.
    ℹ In group 1: `Station.MAC = " podval"`, `Probed.ESSIDs = ""`.
    Caused by warning in `mean.default()`:
    ! аргумент не является числовым или логическим: возвращаю NA
    ℹ Run `dplyr::last_dplyr_warnings()` to see the 12128 remaining warnings.
